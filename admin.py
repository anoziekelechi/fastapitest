...
asyncpg.exceptions.NotNullViolationError: null value in column "country_id" of relation "users" violates not-null constraint
DETAIL:  Failing row contains (1, 2026-08-07 09:33:08.235365+00, 2026-08-07 09:33:08.235441+00, null, null, ANOZIE, KELECHI, kennedykelechijoseph@gmail.com, $2b$12$6PCOyJcDNNfPUxOCeOmhSuczJIu84zfIONZfvkWkJjEJ2Kx3BU9f6, t, f, null, f, t, null).
...
sqlalchemy.dialects.postgresql.asyncpg.AsyncAdapt_asyncpg_dbapi.IntegrityError: <class 'asyncpg.exceptions.NotNullViolationError'>: null value in column "country_id" of relation "users" violates not-null constraint
DETAIL:  Failing row contains (1, 2026-08-07 09:33:08.235365+00, 2026-08-07 09:33:08.235441+00, null, null, ANOZIE, KELECHI, kennedykelechijoseph@gmail.com, $2b$12$6PCOyJcDNNfPUxOCeOmhSuczJIu84zfIONZfvkWkJjEJ2Kx3BU9f6, t, f, null, f, t, null).
...
Traceback (most recent call last):
  ...
  File "/app/.venv/lib/python3.12/site-packages/sqlalchemy/dialects/postgresql/asyncpg.py", line 797, in _handle_exception
    raise translated_error from error
sqlalchemy.exc.IntegrityError: (sqlalchemy.dialects.postgresql.asyncpg.IntegrityError) <class 'asyncpg.exceptions.NotNullViolationError'>: null value in column "country_id" of relation "users" violates not-null constraint
DETAIL:  Failing row contains (1, 2026-08-07 09:33:08.235365+00, 2026-08-07 09:33:08.235441+00, null, null, ANOZIE, KELECHI, kennedykelechijoseph@gmail.com, $2b$12$6PCOyJcDNNfPUxOCeOmhSuczJIu84zfIONZfvkWkJjEJ2Kx3BU9f6, t, f, null, f, t, null).
[SQL: INSERT INTO users (created_at, updated_at, group_id, country_id, surname, othernames, email, hashed_password, is_admin, disabled, payment_id, one_click, verified, date_verified) VALUES ($1::TIMESTAMP WITH TIME ZONE, $2::TIMESTAMP WITH TIME ZONE, $3::INTEGER, $4::INTEGER, $5::VARCHAR, $6::VARCHAR, $7::VARCHAR, $8::VARCHAR, $9::BOOLEAN, $10::BOOLEAN, $11::VARCHAR, $12::BOOLEAN, $13::BOOLEAN, $14::TIMESTAMP WITH TIME ZONE) RETURNING users.id]
[parameters: (datetime.datetime(2026, 8, 7, 9, 33, 8, 235365, tzinfo=datetime.timezone.utc), datetime.datetime(2026, 8, 7, 9, 33, 8, 235441, tzinfo=datetime.timezone.utc), None, None, 'ANOZIE', 'KELECHI', 'kennedykelechijoseph@gmail.com', '$2b$12$6PCOyJcDNNfPUxOCeOmhSuczJIu84zfIONZfvkWkJjEJ2Kx3BU9f6', True, False, None, False, True, None)]
