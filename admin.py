#migration file
"""add home and user model

Revision ID: 7dfcadf8abfb
Revises: 
Create Date: 2026-06-09 13:15:02.373015+00:00
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('groups', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_groups_permission'), ['permission'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_table('home')
    with op.batch_alter_table('groups', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_groups_permission'))
